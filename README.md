...
Issue [#1](https://github.com/au-svt/CompArch-Labs-CSF342-2026F/issues/1) is the live classroom board. Edit its body to post text or links, or drag files into the GitHub editor to attach them. The student homepage reads the rendered issue and checks for updates every 60 seconds; no site deployment is needed.
